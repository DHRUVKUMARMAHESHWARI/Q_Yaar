        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-serif text-xl font-bold">Q-Yaar</span>
            </div>
            <p className="text-muted-foreground leading-relaxed max-w-md">
              Your vehicle's privacy shield and road intelligence partner. Secure your privacy with our digital firewall and navigate roads with live, community-powered hazard alerts.
            </p>
          </div>
